...
<div class="container">
  ...
  <section class="row container" style="text-align:center;">
    ...
    &nbsp;&nbsp;
        ...
        <figure style="display: inline-block;">
          <img src="/resources/images/none.jpg"  alt="Madhav Gupta" height="225" width="225"/>
          <figcaption><a href="">Madhav Gupta</a><br>Undergraduate Research Assistant</figcaption>
        </figure>

   &nbsp;&nbsp;

  <figure style="display: inline-block;">
          <img src="/resources/images/none.jpg" alt="Lars Koesterke" height="225" width="225"/>
          <figcaption><a href="">Lars Koesterke</a><br>Research Associate</figcaption>
        </figure>

   &nbsp;&nbsp;

        <figure style="display: inline-block;">
          <img src="/resources/images/none.jpg"  alt="Drew Barnard" height="225" width="225"/>
          <figcaption><a href="">Drew Barnard</a><br>Undergraduate Research Assistant</figcaption>
        </figure>

   &nbsp;&nbsp;

        <figure style="display: inline-block;">
          <img src="/resources/images/none.jpg"  alt="Mario Molina" height="225" width="225"/>
          <figcaption><a href="">Mario Molina</a><br>Graduate Research Assistant</figcaption>
        </figure>

    &nbsp;&nbsp;

        <figure style="display: inline-block;">
          <img src="/resources/images/none.jpg"  alt="Tatyana Matthews" height="225" width="225"/>
          <figcaption><a href="">Tatyana Mathhews</a><br>SGCI Intern</figcaption>
        </figure>
        ...
        <h2 class="h2 text-center">
          Contributors to FraSPA - the Precursor of IPT
       </h2>
       <div>
  &nbsp;&nbsp;

        <figure style="display: inline-block;">
          <img src="/resources/images/none.jpg" alt="Dr. Purushotham Bangalore" height="225" width="225"/>
          <figcaption><a href="">Dr. Purushotham Bangalore</a><br>Professor, UAB</figcaption>
        </figure>

         &nbsp;&nbsp;

        <figure style="display: inline-block;">
          <img src="/resources/images/none.jpg"  alt="Julio Olaya" height="225" width="225"/>
          <figcaption><a href="">Julio Olaya</a><br>XSEDE intern, UT El Paso</figcaption>
        </figure>

         &nbsp;&nbsp;

        <figure style="display: inline-block;">
          <img src="/resources/images/none.jpg"  alt="Shweta Gulati" height="225" width="225"/>
          <figcaption><a href="">Shweta Gulati</a><br>Graduate Research Assistant, UT Austin</figcaption>
        </figure>

   &nbsp;&nbsp;

        <figure style="display: inline-block;">
          <img src="/resources/images/none.jpg"  alt="Ejenio Capetillo" height="225" width="225"/>
          <figcaption><a href="">Ejenio Capetillo</a><br>Undergraduate Student, UT Austin</figcaption>
        </figure>
